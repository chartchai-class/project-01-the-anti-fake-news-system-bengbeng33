  ...
  <div class="min-h-screen ">
    ...
    <div v-if="loading" class="fixed top-0 left-0 right-0 z-50">
      <div class="h-1 bg-blue-200">
        <div class="h-full bg-blue-500 transition-all duration-300 ease-out" :style="{ width: loadingProgress + '%' }">
        </div>
      </div>
    </div>
    ...
    <div class="flex justify-center">
      <div class="relative inline-block -mt-2 mb-6">
        <img src="/H.png" alt="Daybreak banner" class="w-[520px] max-w-full h-auto pointer-events-none select-none" />
    ...
    <div v-else class="px-4 sm:px-6 lg:px-8 py-6 max-w-6xl mx-auto">
      ...
      <div class="bg-white/95 rounded-2xl p-4 sm:p-6">
        ...
        <div class="block lg:hidden">
          <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mb-3">{{ newsItem.title }}</h1>
          ...
          <div class="flex items-center justify-between mb-3">
            ...
            <div class="text-sm text-gray-600">
              ...
              at <time :datetime="newsItem.reportedAt">{{ formatDate(newsItem.reportedAt) }}</time>
            </div>

            <router-link :to="{ name: 'comments', params: { id: newsId } }"
          ...
          <!-- Image -->
          <div class="mb-4">
            <img v-if="newsItem.imageUrl" :src="newsItem.imageUrl" :alt="newsItem.title"
          ...
          <div class="text-center">
            ...
            <div class="flex justify-center mb-4">
              <img :src="currentStatusImage" :alt="currentStatusText" class="w-40 h-40 object-contain" />
            </div>
            <router-link :to="{ name: 'vote', params: { id: newsId } }"
        ...
        <div class="hidden lg:grid grid-cols-4 gap-8">
          ...
          <div class="col-span-3">
            <h1 class="text-2xl font-bold text-gray-900">{{ newsItem.title }}</h1>
          ...
          <div class="flex flex-col items-center mt-10">
            ...
            <div class="flex items-center justify-center mt-4">
              <img :src="currentStatusImage" :alt="currentStatusText" class="w-48 h-48 object-contain" />
            </div>
            <router-link :to="{ name: 'vote', params: { id: newsId } }"
